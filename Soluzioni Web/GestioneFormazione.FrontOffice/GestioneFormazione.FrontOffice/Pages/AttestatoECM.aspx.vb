...
Public Class AttestatoECM
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'generazione dataset
        Dim dst = getDatasetAttestatiEcm(dbConn, sSql)
    ...
    Private Sub CreatePdfAttestatiEcm(dst As dstAttestatiEcm)
        ...
        rpt.Load(IO.Path.Combine(My.Settings.ReportsBasePath, ContextHandler.NomeReportAttestatoECM), CrystalDecisions.Shared.OpenReportMethod.OpenReportByDefault)
    ...
    Private Function DownloadPossibile(dbConn As SqlConnection, id_ISCRITTO As Integer) As Boolean
        ...
        With dbCmd
            ...
            .CommandText = "sp_fo_GetAndMarkAttestatoECM"
    ...
    Public Function getDatasetAttestatiEcm(dbConn As SqlConnection, sql As String) As dstAttestatiEcm
