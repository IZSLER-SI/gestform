...
Public Class rptFogliFirme
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Softailor.SiteTailorIzs.rptFogliFirme.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFogliFirme
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFogliFirme = New rptFogliFirme()
        rpt.Site = Me.Site
        Return rpt
    End Function
