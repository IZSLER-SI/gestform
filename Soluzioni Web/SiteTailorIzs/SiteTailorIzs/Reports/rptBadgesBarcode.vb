...
Public Class rptBadgesBarcode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Softailor.SiteTailorIzs.rptBadgesBarcode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBadgesBarcode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBadgesBarcode = New rptBadgesBarcode()
        rpt.Site = Me.Site
        Return rpt
    End Function
