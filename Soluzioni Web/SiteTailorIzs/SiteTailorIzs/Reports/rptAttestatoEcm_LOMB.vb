...
Public Class rptAttestatoEcm_LOMB
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAttestatoEcm_LOMB.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Softailor.SiteTailorIzs.rptAttestatoEcm_LOMB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAttestatoEcm_LOMB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAttestatoEcm_LOMB = New rptAttestatoEcm_LOMB()
        rpt.Site = Me.Site
        Return rpt
    End Function
