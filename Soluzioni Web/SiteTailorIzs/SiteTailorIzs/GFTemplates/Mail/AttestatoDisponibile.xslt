...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <!-- con la presente...-->
    <div>
      Con la presente ti informiamo che <b>è disponibile per lo scaricamento il tuo attestato ECM</b> relativo alla partecipazione al seguente evento formativo:
    </div>
    <div>
      <br/>
    </div>
