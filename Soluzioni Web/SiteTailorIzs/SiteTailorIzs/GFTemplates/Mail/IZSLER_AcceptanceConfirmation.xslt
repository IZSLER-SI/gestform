...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="evento">
    ...
    <div>
      ...
      che era stata inserita in lista d'attesa, è stata <b>confermata</b> in quanto si sono liberati dei posti:
    </div>
    <div>
      <br/>
    </div>
    ...
    <div>
      <b>Qualora, nonostante questa conferma, decidessi di rinunciare alla partecipazione</b>, ti raccomandiamo
    ...
    <xsl:if test="@ht_notemailaccettazione!=''">
      <div>
        <br/>
      </div>
      <div>
        <xsl:value-of select="@ht_notemailaccettazione" disable-output-escaping="yes" />
      </div>
    </xsl:if>
    <div>
      <br/>
