...
Public Class CtlSelettoreIndirizzoConEnte
    Inherits WebControl
    ...
    Protected WithEvents txttx_ente As TextBox
...
#Region "proprietà associate ai dati"
    ...
    Public Property tx_ente As String
        Get
            Return txttx_ente.Text.Trim
        End Get
        Set(value As String)
            txttx_ente.Text = value
        End Set
    End Property
...
#End Region
    ...
    Public Sub GenerazioneControlli()
        ...
        Me.Controls.Add(New LiteralControl("<br/><span class=""flbl"" style=""width:90px"">Nome Ente</span>"))
        Me.Controls.Add(txttx_ente)
