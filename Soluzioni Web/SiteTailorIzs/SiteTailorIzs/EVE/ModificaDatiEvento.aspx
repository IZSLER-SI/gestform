<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteTailorMP.Master" CodeBehind="ModificaDatiEvento.aspx.vb" Inherits="Softailor.SiteTailorIzs.ModificaDatiEvento" %>
        ...
        <ContentTemplate>
            <div class="stl_dfo" style="width: 850px;">
                ...
                <table class="fieldtable">
                    ...
                    <tr>
                        <td class="labelcol">ID corso piattaforma</td>
                        <td class="datacol">
                            <asp:TextBox ID="fad_id_CORSO_ATUTOR" runat="server" CssClass="txt txtnarrow" ReadOnly="true" />
                        </td>
                        <td class="errorcol">
                            <asp:Label ID="errfad_id_CORSO_ATUTOR" runat="server" EnableViewState="false" />
                        </td>
                    </tr>
                    <tr>
                        <td class="labelcol">Accreditamento ECM
                            <br />
                            <em>
                                <asp:Label ID="lblNoteAccrECM" runat="server" EnableViewState="false" />
                            </em>
                        </td>
                        <td class="datacol">
                ...
                <div class="endCommands">
                    <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btnlink" Font-Bold="true">Salva Modifiche</asp:LinkButton>
                    <ajaxToolkit:ConfirmButtonExtender ID="cnfUpdate" runat="server" TargetControlID="lnkUpdate" ConfirmText="Confermi il salvataggio delle modifiche?" />
                    &nbsp;
