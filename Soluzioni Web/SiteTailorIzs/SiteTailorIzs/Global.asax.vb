...
Public Class Global_asax
    ...
    Sub Application_Start(ByVal sender As Object, ByVal e As EventArgs)
        ...
        'cartelle
        If System.Configuration.ConfigurationManager.AppSettings("onedrive_skipbasefolderscreation") = "0" Then
            Dim context = Softailor.ReportEngine.SharepointHelper.LogonAndStore(Nothing)
            Softailor.ReportEngine.SharepointHelper.EnsureBaseFoldersCreated(context)
            context.Dispose()
        End If
    ...
    Sub Application_Error(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If ContextHandler.ErrorReportMailTo <> "" Then
            Try
                Dim smtpClient As New System.Net.Mail.SmtpClient()
                Dim mailMsg As New System.Net.Mail.MailMessage
                With mailMsg
                    .From = New System.Net.Mail.MailAddress(ContextHandler.ErrorReportMailFrom)
                    .Subject = ContextHandler.ErrorReportMailSubject
                    .IsBodyHtml = True
                    .Body = ErrorReport()
                    For Each address As String In ContextHandler.ErrorReportMailTo.Split(";"c)
